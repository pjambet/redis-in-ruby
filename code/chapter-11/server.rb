...
require_relative './flush_db_command'
require_relative './bit_ops_commands'
...
require_relative './set_commands'
require_relative './sorted_set_commands'
...
module BYORedis
  ...
  class Server
    ...
    COMMANDS.set('hmget', HMGetCommand)
    COMMANDS.set('hsetnx', HSetNXCommand)
    COMMANDS.set('hstrlen', HStrLenCommand)
    COMMANDS.set('hvals', HValsCommand)
    ...
    COMMANDS.set('smismember', SMIsMemberCommand)
    COMMANDS.set('smembers', SMembersCommand)
    COMMANDS.set('smove', SMoveCommand)
    COMMANDS.set('spop', SPopCommand)
    COMMANDS.set('srandmember', SRandMemberCommand)
    COMMANDS.set('srem', SRemCommand)
    COMMANDS.set('sinter', SInterCommand)
    COMMANDS.set('sinterstore', SInterStoreCommand)
    COMMANDS.set('sunion', SUnionCommand)
    COMMANDS.set('sunionstore', SUnionStoreCommand)
    COMMANDS.set('bzpopmax', BZPopMaxCommand)
    COMMANDS.set('bzpopmin', BZPopMinCommand)
    COMMANDS.set('zadd', ZAddCommand)
    COMMANDS.set('zcard', ZCardCommand)
    COMMANDS.set('zcount', ZCountCommand)
    COMMANDS.set('zincrby', ZIncrByCommand)
    COMMANDS.set('zinter', ZInterCommand)
    COMMANDS.set('zinterstore', ZInterStoreCommand)
    COMMANDS.set('zunion', ZUnionCommand)
    COMMANDS.set('zunionstore', ZUnionStoreCommand)
    COMMANDS.set('zlexcount', ZLexCountCommand)
    COMMANDS.set('zpopmax', ZPopMaxCommand)
    COMMANDS.set('zpopmin', ZPopMinCommand)
    COMMANDS.set('zrange', ZRangeCommand)
    COMMANDS.set('zrangebylex', ZRangeByLexCommand)
    COMMANDS.set('zrangebyscore', ZRangeByScoreCommand)
    COMMANDS.set('zrank', ZRankCommand)
    COMMANDS.set('zrem', ZRemCommand)
    COMMANDS.set('zremrangebylex', ZRemRangeByLexCommand)
    COMMANDS.set('zremrangebyrank', ZRemRangeByRankCommand)
    COMMANDS.set('zremrangebyscore', ZRemRangeByScoreCommand)
    COMMANDS.set('zrevrange', ZRevRangeCommand)
    COMMANDS.set('zrevrangebylex', ZRevRangeByLexCommand)
    COMMANDS.set('zrevrangebyscore', ZRevRangeByScoreCommand)
    COMMANDS.set('zrevrank', ZRevRankCommand)
    COMMANDS.set('zscore', ZScoreCommand)
    COMMANDS.set('zmscore', ZMScoreCommand)
    COMMANDS.set('getbit', GetBitCommand)
    COMMANDS.set('setbit', SetBitCommand)
    COMMANDS.set('bitop', BitOpCommand)
    COMMANDS.set('bitcount', BitCountCommand)
    COMMANDS.set('bitpos', BitPosCommand)
    COMMANDS.set('bitfield', BitFieldCommand)
